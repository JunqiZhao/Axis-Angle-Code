...
%% EFK Execution
   ...
   z=[1,0,0,mydata(1,5)]';
   errZ=[8.2199*10.^-7, 0, 0; 0, 7.4223*10.^-7, 0; 0, 0, 2.45292*10.^-5]; % This is measurement noise, and related to the measurement method, here we assuming using the IMU sensor and used the noise matrix from IMU
   %% Initial Setup
w0 = u1(1,:)'; %turning rate measurement at time0
w1 = u1(2,:)'; %turning rate measurement at time1
